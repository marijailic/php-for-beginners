        ...
        <div class="flex h-16 items-center justify-between">
            <div class="flex items-center">
                <div class="flex-shrink-0">
                    <img class="h-8 w-8" src="/images/tailwindui-icon.svg" alt="Your Company">
                </div>
            ...
            <div class="hidden md:block">
                <div class="ml-4 flex items-center md:ml-6">
                    ...
                    <div class="relative ml-3 flex items-center space-x-3">
                        ...
                        <?php if($_SESSION['user'] ?? false): ?>
                            <div>
                                <!-- <a href="/logout" class="<?= urlIs('/logout') ? 'bg-gray-900 text-white' : 'text-gray-300' ?> rounded-md px-3 py-2 text-sm font-medium hover:bg-gray-700 hover:text-white">Log Out</a> -->
                                <form method="POST" action="/session">
                                    <input type="hidden" name="_method" value="DELETE"/>
                                    <button class="<?= urlIs('/logout') ? 'bg-gray-900 text-white' : 'text-gray-300' ?> rounded-md px-3 py-2 text-sm font-medium hover:bg-gray-700 hover:text-white">Log Out</button>
                                </form>
                            </div>
                        <?php endif; ?>
